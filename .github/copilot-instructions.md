...
### userMemory
- Preference: TypeScript over JavaScript for all new source code files

### sessionMemory
- Decision: TailwindCSS for styling components

### Suggested Actions
- Adhere to guideline: Decision: TailwindCSS for styling components...
- Apply user preference: Preference: TypeScript over JavaScript for all new source code files...
<!-- PERSYST_CONTEXT_END -->

## Proactive Memory Retrieval
- If the required context is NOT found in the Active Context section above, you MUST invoke the `persyst` MCP server's `search_memories` or `get_optimized_context` tool.
